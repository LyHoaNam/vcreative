<template>
  <section class="con-horizontal graphic">
    <EleHeadLine
      title="Top dịch vụ thiết kế xây dựng thương hiệu"
      sub="Xem tất cả"
      href="#"
    />
    <div class="rel">
      <swiper key="graphic" :options="swiperOptions">
        <swiper-slide
      ...
      <div slot="button-prev" class="swiper-button-prev-graphic" />
      <div slot="button-next" class="swiper-button-next-graphic" />
    </div>
  </section>
</template>
<script>
